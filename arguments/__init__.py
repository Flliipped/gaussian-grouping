...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.geo_reliability_pos_tau = 0.65
        self.geo_reliability_neg_tau = 0.35
        self.geo_reliability_alpha_dist = 1.25
        self.geo_reliability_alpha_normal = 2.0
        self.geo_reliability_alpha_plane = 1.5
        self.geo_reliability_alpha_mv = 1.0
        self.proto_enabled = False
        self.proto_num_slots = 16
        self.proto_start_iter = 19_000
        self.proto_interval = 10
        self.proto_warmup_iters = 3000
        self.proto_weight_lambda = 0.0
        self.proto_support_views = 3
        self.proto_max_points = 200000
        self.proto_sample_size = 1200
        self.proto_min_views = 2
        self.proto_conf_tau = 0.7
        self.proto_bank_conf_tau = 0.8
        self.proto_bank_momentum = 0.9
        self.proto_temperature = 0.2
        self.proto_lambda_pull = 1.0
        self.proto_lambda_sep = 0.25
        self.proto_lambda_cons = 0.5
        self.proto_lambda_soft = 0.25
        self.proto_sep_margin = 0.1
        self.proto_min_points = 4
        self.proto_active_count_tau = 32
        self.proto_max_active = 16
        self.proto_update_reliability_tau = 0.55
        self.proto_update_entropy_tau = 0.45
        self.proto_bootstrap_slots = 4
        self.proto_bootstrap_novelty_tau = 0.9
        self.proto_boundary_tau = 0.45
        self.proto_ignore_label = -1
        self.ambiguity_beta_entropy = 1.0
        self.ambiguity_beta_mv = 1.0
        self.ambiguity_beta_rel = 1.0
        self.ambiguity_beta_plane = 0.5
        self.ambiguity_beta_scale = 0.25
        self.split_enabled = False
        self.split_start_iter = 26_000
        self.split_interval = 500
        self.split_max_points = 64
        self.split_ambiguity_tau = 1.1
        self.split_entropy_tau = 0.55
        self.split_margin_tau = 0.2
        self.split_boundary_tau = 0.5
        self.split_scale_shrink = 0.6
        self.split_offset_scale = 0.5
        self.split_opacity_ratio = 0.5
        self.split_feature_blend = 0.7
