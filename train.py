...
def _add_proto_diag_wandb_logs(log_data, proto_diag, iteration):
    ...
    scalar_keys = [
        ...
        "proto_transport_loss",
        "proto_transport_active_ratio",
        "proto_transport_usage_entropy",
        "proto_transport_usage_max",
        "proto_transport_target_entropy",
        "proto_transport_kl",
        "proto_transport_update_blend",
        "proto_transport_capacity_entropy",
    ...
    #        print("image:", image.shape)
        ...
        if proto_active and graph_data is not None and graph_data.get("valid", False):
            ...
            proto_outputs = loss_prototype_learning(
                ...
                transport_update_blend=opt.proto_transport_update_blend,
                transport_iters=opt.proto_transport_iters,
                transport_temperature=opt.proto_transport_temperature,
                transport_reliability_thresh=opt.proto_transport_reliability_thresh,
                transport_entropy_thresh=opt.proto_transport_entropy_thresh,
                transport_assign_conf_thresh=opt.proto_transport_assign_conf_thresh,
                transport_capacity_mode=opt.proto_transport_capacity_mode,
            ...
            if proto_active:
                ...
                if proto_diag:
                    print(
                        ...
                        + f"transport_loss={_proto_diag_scalar(proto_diag, 'proto_transport_loss'):.6f}, "
                        + f"transport_active={_proto_diag_scalar(proto_diag, 'proto_transport_active_ratio'):.6f}, "
...
if __name__ == "__main__":
    ...
    args.proto_transport_update_blend = config.get("proto_transport_update_blend", args.proto_transport_update_blend)
    args.proto_transport_iters = config.get("proto_transport_iters", args.proto_transport_iters)
    args.proto_transport_temperature = config.get("proto_transport_temperature", args.proto_transport_temperature)
    args.proto_transport_reliability_thresh = config.get("proto_transport_reliability_thresh", args.proto_transport_reliability_thresh)
    args.proto_transport_entropy_thresh = config.get("proto_transport_entropy_thresh", args.proto_transport_entropy_thresh)
    args.proto_transport_assign_conf_thresh = config.get("proto_transport_assign_conf_thresh", args.proto_transport_assign_conf_thresh)
    args.proto_transport_capacity_mode = config.get("proto_transport_capacity_mode", args.proto_transport_capacity_mode)
