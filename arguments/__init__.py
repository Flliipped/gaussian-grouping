...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.proto_cons_conf_weight = 0.0
        self.proto_cons_conf_floor = 0.25
        ...
        self.proto_update_conf_thresh = self.proto_conf_thresh
        self.proto_update_reliability_thresh = self.proto_reliability_thresh
        ...
        self.proto_transport_update_blend = 0.5
        self.proto_transport_iters = 3
        self.proto_transport_temperature = 0.10
        ...
        self.use_proto_evidence_anchor = False
        self.proto_lambda_evidence = 0.0
        self.proto_evidence_start_iter = 22000
        self.proto_evidence_interval = 10
        self.proto_evidence_update_blend = 0.0
        self.proto_evidence_min_views = 2
        self.proto_evidence_mv_conf_thresh = 0.55
        self.proto_evidence_reliability_thresh = 0.50
        self.proto_evidence_entropy_thresh = 0.55
        self.proto_evidence_assign_conf_thresh = 0.55
        self.proto_evidence_boundary_thresh = 0.75
